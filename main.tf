terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "taskboardstorsasho2026"
...
provider "azurerm" {
  ...
  subscription_id = "f4065169-62cb-4ea8-9f35-8761ba874ed0"
}
...
resource "azurerm_app_service_source_control" "assc" {
  ...
  repo_url               = "https://github.com/Aleksandar-Stoev/TaskBoardTerraform"
  branch                 = "main"
